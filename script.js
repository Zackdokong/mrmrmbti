...
const lettuceMap = {
    IFJ: {
      ...
      mbti: "IFJ형",
      tag: ["안정", "배려", "신뢰"],
      desc: "조용하지만 기본에 충실하며 꾸준한 성과를 내는 안정형"
    },
    ...
    IFP: {
      ...
      mbti: "IFP형",
      tag: ["감성", "개성", "섬세"],
      desc: "자기만의 감각을 중시하며 부드러운 분위기를 가진 유형"
    },
    ...
    ITJ: {
      ...
      mbti: "ITJ형",
      tag: ["계획", "체계", "효율"],
      desc: "논리적인 사고로 예측 가능한 결과를 만들어내는 유형"
    },
    ...
    EFJ: {
      ...
      mbti: "EFJ형",
      tag: ["조화", "관리", "리더십"],
      desc: "환경을 조율하며 전체 흐름을 안정적으로 이끄는 유형"
    },
    ...
    ITP: {
      ...
      mbti: "ITP형",
      tag: ["분석", "실험", "탐구"],
      desc: "독립적으로 사고하며 조건에 따라 강점을 발휘하는 유형"
    },
