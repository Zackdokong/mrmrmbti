const questions = [
    { q: "사람이 많은 곳에 있으면 오히려 기운이 난다", yes: "E", no: "I" },
    { q: "혼자 조용히 쉬는 시간이 꼭 필요하다", yes: "I", no: "E" },
  
    { q: "계획 없이 바로 행동하는 편이다", yes: "P", no: "J" },
    { q: "미리 정해진 일정이 있어야 마음이 편하다", yes: "J", no: "P" },
  
    { q: "결정할 때 사람의 감정을 먼저 생각한다", yes: "F", no: "T" },
    { q: "감정보다 사실과 논리가 더 중요하다", yes: "T", no: "F" },
  
    { q: "자연스럽게 앞에 나서서 이끄는 역할을 맡는다", yes: "E", no: "I" },
    { q: "깊게 생각하고 분석하는 과정이 재미있다", yes: "T", no: "F" },
  
    { q: "분위기나 관계의 흐름을 잘 느끼는 편이다", yes: "F", no: "T" },
    { q: "결과와 효율이 가장 중요하다고 느낀다", yes: "J", no: "P" },
  ];
...
const lettuceMap = {
    IFJ: {
      ...
      mbti: "IFJ형",
      tag: ["안정", "배려", "신뢰"],
      desc: "조용하지만 책임감이 강하고, 기본에 충실하며 꾸준한 성과를 내는 안정형"
    },
    ...
    IFP: {
      ...
      mbti: "IFP형",
      tag: ["감성", "개성", "섬세"],
      desc: "자기만의 가치와 감각을 중시하며, 섬세하고 부드러운 분위기를 가진 유형"
    },
    ...
    ITJ: {
      ...
      mbti: "ITJ형",
      tag: ["계획", "체계", "효율"],
      desc: "논리적이고 구조적인 사고로 예측 가능한 결과를 만들어내는 유형"
    },
    ...
    ETP: {
      ...
      mbti: "ETP형",
      tag: ["도전", "변화", "실행"],
      desc: "새로운 시도에 강하고, 빠른 판단과 행동으로 현장에서 빛나는 유형"
    },
    ...
    EFP: {
      ...
      mbti: "EFP형",
      tag: ["활력", "다양성", "친화"],
      desc: "에너지가 넘치고 시각적·감정적 만족도가 높아 분위기를 살리는 유형"
    },
    ...
    EFJ: {
      ...
      mbti: "EFJ형",
      tag: ["조화", "관리", "리더십"],
      desc: "사람과 환경을 조율하며 전체 흐름을 안정적으로 이끄는 유형"
    },
    ...
    ITP: {
      ...
      mbti: "ITP형",
      tag: ["분석", "실험", "탐구"],
      desc: "독립적으로 사고하며 조건에 따라 강점을 발휘하는 연구형 유형"
    },
    ...
    ETJ: {
      ...
      mbti: "ETJ형",
      tag: ["성과", "통제", "주도"],
      desc: "목표 지향적이며 대규모 운영과 생산성에서 강한 리더형"
    }
  };
